...
if ( entity ~= NULL_ENTITY ) then
	...
	add_table( remove_comps, EntityGetComponent( entity, 'VariableStorageComponent', 'projectile_arc_set_reflect' ) or { } )
	add_table( remove_comps, EntityGetComponent( entity, 'LuaComponent', 'projectile_arc_set_reflect' ) or { } )
